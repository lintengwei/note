...
- 增加颜色
  - win+R->输入 regedit->定位到 HKEY_CURRENT_USER\Software\Microsoft\Command Processor
...
- xcopy 复制文件和目录树。
- explorer <path> 快速打开文件夹

## 文件管理

- cd .> filename.ext 新建文件
- notepad a.txt 以记事本方式打开文件
- type 显示文本文件的内容。
  - 为什么用 type 不用 read 之类的命令
...
7 del
删除文件,如果path是目录的话,只会删除目录里面的文件,会删除目录的子目录的文件
