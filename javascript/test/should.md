- [should 断言库](#should-%E6%96%AD%E8%A8%80%E5%BA%93)

# should 断言库

[http://shouldjs.github.io/](http://shouldjs.github.io/)
在 Object 下面加了一个 should 属性，该属性的值是 should.Assertion，如下是 should 的声明文件。
